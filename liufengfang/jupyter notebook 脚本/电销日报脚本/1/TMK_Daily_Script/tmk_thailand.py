...
if __name__ == "__main__":
    ...
    # for i in range(31):
    #     end_day = "2024-10-{:02d} 23:59:59".format(i+1)
    #     start_day = '2024-10-01 00:00:00'
    #     loan_end_day = end_day

    # print(start_day,"/t",end_day,"/t",loan_end_day)
    ...
    # 获取数据数据源
    conn_link = conn.conn_th()
    performance_df,attendance_df,process_df,dimission_date_df,first_online_df,required_attendance_df,current_month_first_scheduled_df,organization_df,assign_organization_df,no_count_churn_df = public.get_data(start_day,end_day,loan_end_day,group,conn_link,country = 'th')
    ...
    # 最终美化发送邮件
    # 邮件接收人list
    recipients = config['thailand']['email']

    # print(recipients)

    # recipients = ['liufengfang@weidu.ac.cn','lichongqing@weidu.ac.cn']
    # 邮件主题
