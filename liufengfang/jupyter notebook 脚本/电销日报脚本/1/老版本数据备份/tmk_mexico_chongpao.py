...
if __name__ == "__main__":
    ...
    for i in range(1):
        ...
        end_day = '2024-10-{:02d}'.format(i+1)
        start_day = '2024-10-01 00:00:00'
        loan_end_day = end_day
        end_day = '2024-10-31' + " 23:59:59"
        start_day = '2024-10-01' + ' 00:00:00'
        loan_end_day = '2024-11-06' + " 23:59:59"
        print(start_day,end_day,loan_end_day)
        # 数据保存路径
        ...
        beautify_send(员工数据_result, 组长业绩数据_result, 主管业绩数据_result, path)
