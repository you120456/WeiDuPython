...
if __name__ == "__main__":
    ...
    # for i in range (3):
    #     print(6+i)
    #     start_day='2024-{}-21 00:00:00'.format(i+5)
    #     end_day='2024-{}-20 23:59:59'.format(i+6)
    #     loan_end_day = '2024-{}-26 23:59:59'.format(i+6)
    #     country='墨西哥'

    for i in range (1):
        start_day='2024-10-01 00:00:00'
        end_day='2024-10-16 23:59:59'
        loan_end_day = '2024-10-16 23:59:59'
        country='墨西哥'
    ...
    # 数据保存路径
        ...
        group = ",".join(f"'{cf}'" for cf in config['thailand']['group'])
        ...
        # 邮件内容
        body =r"""<!DOCTYPE html><html><head><style>.indented {margin-left: 20px;}</style></head><body><p>各位好！</p> <p>&nbsp;&nbsp;&nbsp;&nbsp;附件是泰国电销日报数据，请查收！谢谢！</p></body></html>"""
